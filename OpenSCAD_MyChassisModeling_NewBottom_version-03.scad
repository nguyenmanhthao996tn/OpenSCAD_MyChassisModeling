...
//    draw_extender();
//    draw_extender_rotational_fixing_part();
//}
...
module draw_extender_rotational_fixing_part() {
    // Extender rotational fixing part
    difference() {
        union() {
            cylinder(h=extender_rotational_fixing_part_height, d=extender_rotational_fixing_part_inner_diameter+extender_rotational_fixing_part_thickness, center=false);
            
            // Square fixing cube outside the ring
            translate([0,0, (extender_rotational_fixing_part_negative_depth/2)]) {
                cube([extender_rotational_fixing_part_inner_diameter+extender_rotational_fixing_part_thickness+(1.5*2), 1.5, extender_rotational_fixing_part_negative_depth], center=true);
                cube([1.5, extender_rotational_fixing_part_inner_diameter+extender_rotational_fixing_part_thickness+(1.5*2), extender_rotational_fixing_part_negative_depth], center=true);
            }
        }
        
        // Inner cutout
        cylinder(h=500, d=extender_rotational_fixing_part_inner_diameter, center=true);
        
        // Screws cutout
        translate([0,0,extender_rotational_fixing_part_height/2]) {
            rotate([90, 0, -45])
            cylinder(h=500, d=extender_rotational_fixing_part_hole_diameter, center=true);
